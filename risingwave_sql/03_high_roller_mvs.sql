...
--   avg_bet ~$200-2000, pct_baccarat ~0.65 (the Macau VIP signal),
--   pct_blackjack ~0.30, fnb_spend ~$80-300, hotel_spend >0,
...
SELECT
    ...
    -- Baccarat affinity is the dominant behavioral signal on a Macau floor —
    ...
    (
      ...
      + 0.20 * LEAST(pct_baccarat / 0.65, 1.0)
      + 0.10 * LEAST(pct_blackjack / 0.30, 1.0)
