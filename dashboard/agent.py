...
- **House edges (house advantage) by game:** Slots 7.50%, Baccarat 1.15% (blended banker/player/tie — the Macau hero game), Blackjack 0.75%. These are the hardcoded per-game edges used to compute theo_win.
